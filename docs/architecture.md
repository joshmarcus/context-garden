...
| `multiplayer_client.py` | the local installation's authenticated coordinator client shared by scheduler and web workflows: cached authoritative views, protocol compatibility and reconnect diagnostics, revision-fenced commands, and conflict-aware local projection synchronization |
