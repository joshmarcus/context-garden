...
| `multiplayer_client.py` | the local installation's authenticated coordinator client, cached authoritative view, protocol compatibility checks, and reconnect diagnostics |
