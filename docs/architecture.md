...
| `multiplayer_client.py` | the installation-bound coordinator client shared by scheduler and web workflows: authenticated snapshot caching, revision-fenced commands, and conflict-aware local projection synchronization |
