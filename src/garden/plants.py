...
<g id="st-fruit"><path d="M12 7 L14 2" stroke="var(--ink)" stroke-width="1"/><circle cx="9" cy="13" r="3.4" fill="var(--berry)" stroke="var(--ink)" stroke-width=".7"/><circle cx="15" cy="13" r="3.4" fill="var(--berry)" stroke="var(--ink)" stroke-width=".7"/><circle cx="12" cy="8.5" r="3.4" fill="var(--berry)" stroke="var(--ink)" stroke-width=".7"/><circle cx="12" cy="17.5" r="3.4" fill="var(--berry)" stroke="var(--ink)" stroke-width=".7"/></g>
