...
DEFAULTS: dict[str, Any] = {
    ...
    "operating_profile": "",  # Default configured concurrency; legacy empty/plain/balanced map to Default
    "profiles": {},  # custom partial stop; built-ins are economy (0.5x), default (1x), fast (2x)
    "products": {},
